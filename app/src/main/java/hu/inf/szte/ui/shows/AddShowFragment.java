...
import hu.inf.szte.databinding.FragmentAddshowBinding;
import hu.inf.szte.ui.movies.MoviesFragment;

public class AddShowFragment extends Fragment {

    private FragmentAddshowBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        AddShowViewModel homeViewModel =
                new ViewModelProvider(this).get(AddShowViewModel.class);
